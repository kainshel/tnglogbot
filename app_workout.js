import {DB, groups, uid, today, toast} from './exercises.json';
...
Object.keys(groups).forEach(g=>{ const o=document.createElement('option'); o.value=g;o.textContent=g; pickGroup.appendChild(o); });
...
function fillSub(){
  ...
  const subs = groups[g]||[]; subs.forEach(s=>{ const o=document.createElement('option'); o.value=s;o.textContent=s; pickSubgroup.appendChild(o); });
